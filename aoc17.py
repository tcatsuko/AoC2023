...
def minium_heat_loss(minsteps, maxsteps):
    dir_right = (1,0)
    dir_left = (-1,0)
    dir_up = (0,-1)
    dir_down = (0,1)
    ...
    return min(endpoint_values)
print('Part 1: minimum heat loss is ' + str(minium_heat_loss(1, 3)))
print('Part 2: minimum heat loss is ' + str(minium_heat_loss(4, 10)))